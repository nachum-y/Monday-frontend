<template>
    <!-- <draggable v-model="board.colsOrder" tag="tr" class="row header" ghost-class="ghost" :item-key="key => key">
    ...
    <div v-if="board" class="board-content">
        <div class="board-content-group" v-for="group in board.groups" :key="group.id">
            ...
            <draggable v-model="colsOrder1" tag="tr" class="board-content-group-row-header header" ghost-class="ghost"
                :item-key="key => key">
                <template #item="{ element: col }">
                    <div v-if="col.title === 'Item'" class="header-col fixed">
                        <div class="task-item">
                            <div class="item-select">
                                <div class="checkbox"></div>
                            </div>
