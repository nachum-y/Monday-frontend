  ...
  <section v-if="board" class="main-header">
    ...
    <section class="sub-header-nav">
      <div class="view-btn-holder">
        <button class="main-tab header-btn" :class="isActive">
        ...
        <button class="main-tab header-btn kanban-btn" :class="isActive">
          <router-link :to="{ name: 'kanban' }">kanban</router-link>
          <span class="icon-v2-ellipsis"></span>
        </button>
        <div class="views-seprator"></div>
        <button class="main-tab header-btn dashboard-btn" :class="isActive">
        ...
        <div class="views-seprator"></div>
        <button class="main-tab header-btn card-btn" :class="isActive">
