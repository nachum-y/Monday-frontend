  ...
  <div class="main-header-nav">
    <div class="board-title-component">
      <el-tooltip content="Click to edit" effect="dark">
        <input :style="{'width': ((board.title.length) * 1) + 'ch'}" onkeypress="this.style.width = ((this.value.length + 2) * 1) + 'ch';" @click="handleInput" @change="updateBoardTitle" type="text" :value="board.title">
      </el-tooltip>
