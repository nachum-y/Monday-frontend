...
<div class="board-header-view-bar">
  <div class="board-filter new-board-filter monday-v2-header">
    ...
    <div class="filter-buttons-wrapper">
      <div class="board-filter-input-container board-filter-search board-filter-input-container--expandable">
       ...
       <el-tooltip content="Filter by person" effect="dark">
        ...
        <div class="board-filter-item-content-wrapper">
          <span class="">
            <div class="monday-style-clickable board-filter-item-content person-filter-component show-title-when-closed show-title-when-open monday-style-clickable--disable-text-selection" data-testid="clickable" role="button" tabindex="0" aria-label="Filter by person" aria-haspopup="dialog">
       ...
       <el-tooltip content="Filter by anything" effect="dark">
        ...
        <div class="board-filter-item-content-wrapper">
          <span class="">
            <div class="monday-style-clickable board-filter-item-content rule-based-filer-component with-caret show-title-when-closed show-title-when-open monday-style-clickable--disable-text-selection" role="button">
       ...
       <el-tooltip content="Sort by any column" effect="dark">
        ...
        <div class="board-filter-item-content-wrapper">
          <span class="">
            <div class="monday-style-clickable board-filter-item-content sort-settings-component show-title-when-closed show-title-when-open monday-style-clickable--disable-text-selection">
       ...
       <el-tooltip content="Hidden colunms" effect="dark">
        ...
        <div class="board-filter-item-content-wrapper item-state-exit-done">
          <span class="">
            <div class="monday-style-clickable board-filter-item-content columns-filter-component show-title-when-closed show-title-when-open monday-style-clickable--disable-text-selection">
      ...
      <div>
        <button type="button" class="menu-button--wrapper board-filters-overflow-menu-item menu-button--wrapper--size-32">
